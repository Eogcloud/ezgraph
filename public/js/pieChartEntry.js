...
function addInput(divName){
     if (counter === limit){
          ...
          valueDiv.innerHTML = "<input style='margin-top: 5%' type='number' name='pieValues[]' class='form-control' placeholder='Enter Sector Value'></input>"
          labelDiv.innerHTML = "<input style='margin-top: 5%' type='text' name='pieLabels[]' class='form-control' placeholder='Enter Sector Label'></input>"
